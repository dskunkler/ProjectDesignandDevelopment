 ...
 */
#include "src/s_local_simulator.h"
...
bool sLocalSimulator::Start() {
  ...
  // CC Eastbound stops
  Stop * stop_CC_EB_1 = new Stop(0, 44.972392, -93.243774);  // West bank st
  Stop * stop_CC_EB_2 = new Stop(1, 44.975392, -93.226632);  // Oak St & Wash
  ...
  Stop * stop_CC_WB_2 = new Stop(5, 44.983703, -93.178846);  // Fairgrounds
  Stop * stop_CC_WB_3 = new Stop(6, 44.976397, -93.221801);  // before transit
  Stop * stop_CC_WB_4 = new Stop(7, 44.978366, -93.236038);  // Jones-Eddy
  Stop * stop_CC_WB_5 = new Stop(8, 44.972638, -93.243591);  // Blegen
