 ...
 *
 * Calls to \ref Passenger generate a new Passenger instance default name is
...
/**
 * @brief Returns bool true or false, default false
 *
 * @return time_on_bus_ > 0 true or false
 */
  bool IsOnBus() const;
/**
